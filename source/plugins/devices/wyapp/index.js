...
export function setup(options, imports, register)
{
	...
	let deviceDriver = {
		defaultIcon()
		{
			return 'plugins/devices/wyapp/data/img/icons/network.png';
		},
	...
	if (workspace)
	{
		...
		}, 'plugins/devices/wyapp/data/img/icons/stop-icon.svg', {
			visible () {
				let device = studio.workspace.getDevice ();
		...
		}, 'plugins/devices/wyapp/data/img/icons/fileexplorer-icon.svg', {
			visible () {
				let device = studio.workspace.getDevice ();
		...
		}, 'plugins/devices/wyapp/data/img/icons/task-manager-icon.svg', {
			visible () {
				let device = studio.workspace.getDevice ();
		...
		}, 'plugins/devices/wyapp/data/img/icons/library-icon.svg', {
			visible () {
				let device = studio.workspace.getDevice ();
		...
		}, 'plugins/devices/wyapp/data/img/icons/network-manager-icon.svg', {
			visible () {
				let device = studio.workspace.getDevice ();
